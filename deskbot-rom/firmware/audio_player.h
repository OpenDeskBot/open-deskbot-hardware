...
#define AUDIO_PLAY_QUEUE_DEPTH 32
#endif
...
bool audio_stream_pcm16_push_copy(const int16_t* samples, size_t num_samples,
...
/** audio_play 任务输入队列中待处理消息数（含未播 chunk）；用于 pb opportunistic。 */
